...
##creating a [2,2] graph space to plot the desires plots, adding the graphs and legend.
png(filename="plot4.png")
par(mfrow = c(2,2))
plot(DT$Date, DT$Global_active_power, type="l", xlab="", ylab="Global Active Power")
...
plot(DT$Date, DT$Global_reactive_power, type="l", xlab="datatime", ylab="Global Reactive Power")
dev.off()